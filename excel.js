(function() {
    ...
    class Excel extends HTMLElement {
        ...
        onCustomWidgetAfterUpdate(changedProperties) {
            ...
            let xlsxjs = "https://vighnesh27.github.io/sac_a/xlsx.js";
    ...
    customElements.define("com-mindset-excel", Excel);
              ...
              onValidate: function(e) {
                ...
                reader.onload = async function(e) {
                  ...
                  if (correctsheet) {
                    ...
                    var ar_colnames = result.split("[$@~!~@$]")[0].split("[#@~!~@#]");
                    var arcollen = result.split("[$@~!~@$]")[0].split("[#@~!~@#]").length;
                        ...
                        if (result.split("[$@~!~@$]")[i].length > 0) {
                          ...
                          if (rec.length === arcollen) {
                            ...
                            if (arlenfinal > 0) {
                              ...
                              for(var k = 0;k<arcollen;k++)
                              {
                                
                                actcolum[ar_colnames[k]] = rec[k].trim();
                             
                              
                            }
                            result_final.push(actcolum);
